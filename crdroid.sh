...
git clone https://github.com/legacyO7/android_device_asus_X01BD.git device/asus/X01BD
rm -rf kernel/asus/sdm660
git clone https://github.com/legacyO7/katnis_.git kernel/asus/sdm660
#git clone https://github.com/SonalSingh18/android_kernel_asus_sdm660.git -b ten kernel/asus/sdm660
rm -rf vendor/asus/X01BD
git clone https://github.com/legacyO7/android_vendor_asus_X01BD vendor/asus/X01BD
